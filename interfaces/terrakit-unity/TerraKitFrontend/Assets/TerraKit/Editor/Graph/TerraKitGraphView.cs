...
namespace TerraKit.Editor
{
    internal sealed class TerraKitGraphView : GraphView
    {
        ...
        public void Load(TerraKitGraphAsset graphAsset)
        {
...
#pragma warning restore CS0618
        ...
        private TerraKitNodeView AddNodeView(TerraKitNodeData nodeData)
        {
            ...
            var nodeView = new TerraKitNodeView(nodeData, definition);
        ...
        private void OnKeyDown(KeyDownEvent evt)
        {
            ...
            else if (evt.keyCode == KeyCode.Alpha1 || evt.keyCode == KeyCode.Keypad1)
            {
                ResetZoomTo100Percent();
                evt.StopPropagation();
            }
        }
        ...
        private GraphViewChange OnGraphViewChanged(GraphViewChange change)
        {
            ...
            {
                Undo.RecordObject(_graphAsset, "Move TerraKit Node");
                dirty = true;
            }

...
namespace TerraKit
{
    ...
    /// <summary>
    /// Managed representation of a native backend parameter value.
    /// </summary>
    ...
    /// <summary>
    /// Reads built-in stage schemas from the native TerraKit registry.
    /// </summary>
    public static class TerraKitBackendSchemaDiscovery
    {
        public static IReadOnlyList<TerraKitBackendStageSchema> DiscoverBuiltInStages()
        {
            ...
            // Verify that managed structs match the native ABI before reading memory.
            ...
            {
                // Always release the native registry, even if schema discovery fails.
        ...
        internal static void Validate()
        {
            if (IntPtr.Size != 8)
            {
                throw new PlatformNotSupportedException(
                    "TerraKit ABI 1.0 currently requires a 64-bit Unity process.");
            }
    ...
    // P/Invoke bindings for the native TerraKit stage registry API.
